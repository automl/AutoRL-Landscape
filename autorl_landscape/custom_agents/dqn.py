...
from autorl_landscape.custom_agents.off_policy_algorithm import (
    custom_collect_rollouts,
    finish_collect_rollouts,
)
...
class CustomDQN(DQN):
    ...
    def custom_save(self, locals: Dict[str, Any], save_path: str, seed: int) -> None:
        ...
        finish_collect_rollouts(save_model, locals)
